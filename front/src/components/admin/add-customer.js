...
const AddCustomer = ({visible, setVisible}) => {
    ...
    const handleSubmit = async (event, createCustomer) => {
        console.log("In the handleSubmit");
        event.preventDefault();
        const res = await createCustomer();
        setVisible(false);
        info("مشتری با موفقیت اضافه شد", "");
    };
            ...
            {(createCustomer, {loading, error}) => {
                return (
                   <Modal
                        ...
                        visible={visible}
                        onOk = {event => handleSubmit(event, createCustomer)}
                        ...
                        >
                            <Form
                                name="add customer in all customers list"
                                {...editItemLayout}
