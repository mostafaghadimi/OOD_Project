...
> npm start
		...
		\end{latin}
	\پایان{شمارش}
	\فقره \مهم{\لر{PWA}}: برای نصب نرم‌افزار موبایل، باید مراحل زیر را طی کرد.	
		\شروع{شمارش}
			\فقره ابتدا باید داخل پوشه \لر{front} رفته و دستور زیر را اجرا کرد.
		\begin{latin}
			\begin{verbatim}
> npm run-script build
			\end{verbatim}
		\end{latin}
			\فقره در این مرحله بر روی سرور محلی \زیرنویس{\لر{localhost}} باید دستور زیر را وارد کنیم.
		\begin{latin}
			\begin{verbatim}
